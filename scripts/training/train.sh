...
#SBATCH -o /home/jhoefer/sandbox/results/kang/top_2000/logs/slurm/slurm.%N.%j.out          
#SBATCH -e /home/jhoefer/sandbox/results/kang/top_2000/logs/slurm/slurm.%N.%j.err
